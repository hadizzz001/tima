...
const fetchCategories = async () => {
    try {
        ...
        if (response.ok) {
            ...
            const limitedData = data.slice(0, 5); // Limit to 5 items
                        ...
                        <>
                            ...
                            <div className="  ProductTile-SliderContainer ProductTile-SliderContainer--YMAL px-3" data-product-list-category="ymal-slider">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    <h1 className="py-2 leading-[0rem] font-stretch-[66.66%] not-italic tracking-widest uppercase text-[#a17778] transition text-nowrap font-bold text-3xl myBB">
                                        New Arrivals
                                    </h1>
                                    <button
                                    id='mybbtn' 
                                ...
                                <div className="w-[70px] h-[5px] bg-[#a17778] mt-1 mb-5"></div>
