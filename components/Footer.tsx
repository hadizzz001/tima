    ...
    return (
        ...
        >
            ...
            <style
                ...
                dangerouslySetInnerHTML={{
                    __html:
                        ".NewsletterSignupFooter{display:block;background:#eeeeee;padding:20px 15px}.NewsletterSignupFooter_Component{margin:20px auto;min-height:42px;max-width:454px}.NewsletterSignupFooter_Disclaimer{max-width:454px;margin:0 auto}.NewsletterSignupFooter_Disclaimer a,.NewsletterSignupFooter_Disclaimer a:hover,.NewsletterSignupFooter_Disclaimer a:visited,.NewsletterSignupFooter_Disclaimer a:active{color:#a17778}@media (min-width: 1280px){.NewsletterSignupFooter_Heading{line-height:2.5rem;font-size:1.75rem}}\n"
                }}
            />
            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/timabeautycosmetics"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/share/1BdMfCRTGH/"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            <div className="column mb-5"  >
                                <p className="question myBB">
                                    ...
                                    <span>
                                        Contact{" "}
                                        <a
                                            href="mailto:info@Tima Beauty Cosmetics-lb.com"
                                            data-auto-id="true"
                                            id="page-footer-mailto-support-bellroy-com-1"
                                            className='myBB'
                                        >
                                            info@Tima Beauty Cosmetics-lb.com
                                        </a>
                                    </span>
                                </p>
                            </div>
                            <div className="column">
                                <span className="copyright myBB">
                                    All rights reserved © {(new Date().getFullYear())} Tima Beauty Cosmetics
                                </span>
                            </div>
                        </div>
                    </div>
